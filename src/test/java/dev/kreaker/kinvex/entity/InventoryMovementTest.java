...
class InventoryMovementTest {
    ...
    void createInventoryMovement_WithValidData_ShouldPass() {
        ...
        InventoryMovement movement =
                new InventoryMovement(testProduct, InventoryMovement.MovementType.IN, 10);
        ...
        assertThat(movement.getReferenceType())
                .isEqualTo(InventoryMovement.ReferenceType.PURCHASE_ORDER);
    ...
    void createInventoryMovement_WithNullProduct_ShouldFailValidation() {
        // Given
        InventoryMovement movement =
                new InventoryMovement(null, InventoryMovement.MovementType.IN, 10);
    ...
    void createInventoryMovement_WithNullQuantity_ShouldFailValidation() {
        // Given
        InventoryMovement movement =
                new InventoryMovement(testProduct, InventoryMovement.MovementType.IN, null);
    ...
    void isOutbound_WithOutMovementType_ShouldReturnTrue() {
        // Given
        InventoryMovement movement =
                new InventoryMovement(testProduct, InventoryMovement.MovementType.OUT, 10);
    ...
    void movementType_AllTypes_ShouldBeValid() {
        ...
        InventoryMovement inMovement =
                new InventoryMovement(testProduct, InventoryMovement.MovementType.IN, 10);
        InventoryMovement outMovement =
                new InventoryMovement(testProduct, InventoryMovement.MovementType.OUT, 10);
    ...
    void referenceType_AllTypes_ShouldBeValid() {
        ...
        assertThat(movement.getReferenceType())
                .isEqualTo(InventoryMovement.ReferenceType.ADJUSTMENT);
