...
/**
 * Excepción lanzada cuando se intenta realizar una operación que entra en
 * conflicto con el estado actual de una orden de compra.
 *
 * Ejemplos: - Intentar recibir productos de una orden cancelada - Intentar
 * cancelar una orden ya completada - Intentar modificar una orden que ya está
 * en proceso
 */
