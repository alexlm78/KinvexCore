...
/**
 * Propiedades de configuración de la aplicación Kinvex. Mapea las propiedades personalizadas
...
public record AppProperties(
    ...
    public record Security(boolean requireSsl, int sessionTimeout) {}

    public record Monitoring(boolean enabled, boolean metricsEnabled) {}
