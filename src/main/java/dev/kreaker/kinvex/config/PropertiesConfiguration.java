...
/**
 * Configuración que habilita las propiedades personalizadas de la aplicación. Esta clase registra
 * todas las clases de propiedades para que Spring Boot las procese automáticamente.
 */
@Configuration
